...
RUN apk add --no-cache --virtual .pynacl_deps build-base python3-dev libffi-dev openssl-dev mariadb-dev musl-dev zlib-dev py-pip jpeg-dev zlib-dev glib pango cairo tzdata
